//Nav
export const $navInicio = document.getElementById('inicio'); 
export const $navTemaClaro = document.getElementById('claro'); 
...
//Formulario nombre departamento
export const $formAddDep = document.getElementById('form-add-dep'); 
export const $inputDep = document.getElementById('input-dep'); 
export const $btnDep = document.querySelector('.btnDep'); 
